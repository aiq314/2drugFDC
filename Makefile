...
LDFLAGS  += -g -L/opt/prog/sundial/lib64 -lsundials_cvode -lsundials_nvecserial -L/usr/lib64 -lnlopt_cxx -lm
#LDFLAGS  += -g -L/opt/prog/sundial/lib64 -lsundials_cvode -lsundials_nvecserial -lm
